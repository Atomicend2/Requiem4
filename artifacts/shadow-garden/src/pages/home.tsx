    ...
    <div className="min-h-[100dvh]">
      ...
      <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <a href="https://chat.whatsapp.com/Dvr9aW1HeJQ2NA1RyqhrBQ" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
      ...
      <section className="py-24 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto">
          ...
          <a href="https://chat.whatsapp.com/Dvr9aW1HeJQ2NA1RyqhrBQ" target="_blank" rel="noopener noreferrer">
...
const COMMUNITY_GROUPS = [
  ...
  },
  {
    ...
    url: "https://chat.whatsapp.com/ImIccJmupOWGwtvidmagv4?s=cl&p=a&ilr=1&amv=2",
  },
  {
    icon: Dices,
    name: "gambling",
    ...
    url: "https://chat.whatsapp.com/JNAUOAw9IuyIMKeV8L2Nv8?s=cl&p=a&ilr=1&amv=2",
  },
];
